...
@IBDesignable class itemsfield: UITextField
{
        ...
        func customizedView()
        {
            ...
            attributedPlaceholder = NSAttributedString(string: "items Price", attributes: [.foregroundColor: UIColor(white: 1, alpha: 0.97)])
